from pyforchange.nqs.core.reader import settings
from pyforchange.nqs.core.quantum import quantum
from pyforchange.egg.resources.extensions import nqa
from pyforchange.egg.resources.parser import Parser
