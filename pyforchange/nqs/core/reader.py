from pyforchange.egg.library import nqsCommands, eggConsoleCommands
from pyforchange.nqs.core.functions import Func,clear
from pyforchange.egg.resources.console import sleep
